				...
				<div class="container-full">
					<div class="container">
						...
						<!--▼temporary if exists db record▼-->
							...
							<ul id="list" class="my_movie">
								<iframe src="https://www.youtube.com/embed/LXshJfC6C0M?modestbranding=1&showinfo=0" frameborder="0" allowfullscreen></iframe>
							</ul>
							<ul>
								<p class="my_text">このはーるのーうたー<br />このはーるのーうたー<br />spring days</p>
							</ul>
							<ul>
								<a href="../public/image/haru1.jpg" data-lity><img src="../public/image/haru1.jpg" alt="" style="width:10%;" /></a>
							</ul>
						<!--▲temporary▲-->
					</div>
				</div>
